...
def load_data(data):
    if(data == "cifar10"):
        ...
        train_dir = './dataset/Fed_MNIST/fed_emnist_all_trainset.pt'
        test_dir = './dataset/Fed_MNIST/fed_emnist_all_valset.pt'
...
def poison_dataset(dataset, selectedDataset, data_idxs=None, agent_idx=-1, poison_all=False, pattern='plus'):
    ...
    for idx in poison_idxs:
        ...
        bd_img = add_pattern_bd(clean_img, selectedDataset, pattern_type=pattern, agent_idx=agent_idx)
        if selectedDataset == 'fedmnist':
